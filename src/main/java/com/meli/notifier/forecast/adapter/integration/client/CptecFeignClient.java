...
import com.meli.notifier.forecast.adapter.integration.config.CptecClientConfig;
...
@FeignClient(name = "cptec-api", url = "${external.services.cptec.api.base-url}", configuration = CptecClientConfig.class)
