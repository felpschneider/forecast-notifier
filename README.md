...
Perfeito! Com base no seu novo diagrama, aqui está um trecho de **README** para incluir no seu repositório, com uma explicação clara da **arquitetura proposta** e **racional por trás das escolhas**. Está em português, como solicitado:
...
## Endpoints
Abaixo estão os principais endpoints da API, para acessar a documentação completa, consulte o [Swagger](http://localhost:8080/api/swagger-ui/index.html).
